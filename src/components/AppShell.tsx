  ...
  return (
    <Sidebar collapsible="icon">
      ...
      <SidebarFooter className="border-t border-sidebar-border/60">
        {(() => {
          const caregiver = data.caregivers.find((c) => c.id === data.currentCaregiverId);
          const patient =
            ...
            <div className="space-y-1">
              {patient && (
                <div className="flex items-center gap-3 rounded-xl px-2 py-2 group-data-[collapsible=icon]:hidden">
                  <SidebarProfileAvatar photo={patient.photo} name={patient.name} />
                  <div className="min-w-0 flex-1">
                    <p className="truncate text-sm font-semibold">{patient.name}</p>
                    <p className="truncate text-xs text-muted-foreground">Paziente</p>
                  </div>
                </div>
              )}
              ...
              {caregiver && (
                <div className="flex items-center gap-3 rounded-xl px-2 py-2 group-data-[collapsible=icon]:hidden">
                  <SidebarProfileAvatar photo={caregiver.photo} name={caregiver.name} caregiver />
                  <div className="min-w-0 flex-1">

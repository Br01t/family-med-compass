    ...
    <PublicPageShell currentPath="/cookie">
      <div className="py-6 sm:py-8 max-w-3xl mx-auto">
        ...
        <article className="prose max-w-none rounded-3xl border border-stone-200/80 bg-white/85 p-6 sm:p-12 shadow-sm backdrop-blur-sm">
          <h1 className="font-display text-3xl sm:text-4xl font-bold text-stone-900 italic">Cookie Policy</h1>
          <p className="text-xs sm:text-sm text-stone-500 font-normal">Ultimo aggiornamento: 31 agosto 2026</p>

...
function LandingPage() {
  const { data, setRole, setCurrentPatient } = useFamilyMed();
        ...
        <div className="grid gap-10 md:grid-cols-2 md:items-center">
          <div className="fm-reveal">
            ...
            <p className="mt-5 max-w-md text-base text-muted-foreground md:text-lg">
              Per il paziente: un pulsante grande "Ho preso la medicina". Per i
              familiari: monitoraggio in tempo reale, alert, scorte e storico.
            </p>
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              >
                <Link to="/paziente">
                  Entra come {patient.name.split(" ")[0]}
              ...
              <Button
                ...
                asChild
              >
                <Link to="/caregiver">Vista Caregiver</Link>
              </Button>
            </div>
